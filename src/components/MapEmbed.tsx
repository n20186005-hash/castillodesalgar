...
export default function MapEmbed() {
  ...
  const mapsUrl = "https://maps.app.goo.gl/vXzDinGQpDKK6Pjj9";
    ...
    <section id="map" className="section-padding" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          */}
          <iframe
            src="https://maps.google.com/maps?q=Castle+Salgar,+Cl.+9+%231316,+Salgar,+Puerto+Colombia,+Atl%C3%A1ntico,+Colombia&t=&z=15&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen
            ...
            title="Google Maps - Castle Salgar"
          />
        </div>
