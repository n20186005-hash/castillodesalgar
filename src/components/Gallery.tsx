...
const photoFiles = [
  ...
  'castle-salgar (8).jpg',
  'castle-salgar (9).jpg',
  'castle-salgar (10).jpg',
  'castle-salgar (11).jpg',
  'castle-salgar (12).jpg',
  'castle-salgar (13).jpg',
  'castle-salgar (14).jpg',
  'castle-salgar (15).jpg',
  'castle-salgar (16).jpg',
  'castle-salgar (17).jpg',
  'castle-salgar (18).jpg',
  'castle-salgar (19).jpg',
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-8">
              <a
                href="https://maps.app.goo.gl/vXzDinGQpDKK6Pjj9"
                target="_blank"
